...
// 🔴 REQ-2026-172 DEC-3: `readTicketFacts` 는 `lib/integration-facts` 로 이관됐다(preflight 와 공유).
//    re-export 로 기존 import 경로·테스트를 그대로 둔다 — 동작은 바뀌지 않았다.
export { readTicketFacts }
