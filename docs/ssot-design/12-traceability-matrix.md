...
| 일관성 게이트 | 화면 D | `req:doctor <id> [--finalize]` | §1.4 | state·응답·증거 | D-체크 전수(`D1/D4/D4a/D7/D7b/D8/D12/D14`는 예약 결번) — 목록은 [07](07-business-rules-and-state-machines.md) §3 정본, id 권위는 `D_CHECK_IDS` | 게이트 | req-doctor.test.ts · docs-stale-claims.test.ts | [scripts/req/req-doctor.ts](../../scripts/req/req-doctor.ts) | [07](07-business-rules-and-state-machines.md) §3 |
